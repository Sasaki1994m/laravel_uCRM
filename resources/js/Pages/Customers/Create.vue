                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.name" class="text-red-400">{{ errors.name }}</div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.kana" class="text-red-400">{{ errors.kana }}</div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.tel" class="text-red-400">{{ errors.tel }}</div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.email" class="text-red-400">{{ errors.email }}</div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.postcode" class="text-red-400">{{ errors.postcode }}</div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.address" class="text-red-400">{{ errors.address }}</div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.birthday" class="text-red-400">{{ errors.birthday }}</div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="radio" id="man" name="gender" v-model="form.gender" value="0" >
                                            <label for="man" class="ml-2 mr-4">男</label>
                                            <input type="radio" id="woman" name="gender" v-model="form.gender" value="1" >
                                            <label for="woman" class="ml-2 mr-4">女</label>
                                            <input type="radio" id="others" name="gender" v-model="form.gender" value="2" >
                                            <label for="others" class="ml-2 mr-4">その他</label>
                                            <div v-if="errors.gender" class="text-red-400">{{ errors.gender }}</div>
                                        </div>
                                        </div>
