                                ...
                                <div class="container px-5 py-8 mx-auto">
                                    ...
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.date" class="text-red-400">{{ errors.date }}</div>
                                        </div>
                                        </div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <div v-if="errors.customer" class="text-red-400">{{ errors.date }}</div>
                                        </div>
                                        </div>
