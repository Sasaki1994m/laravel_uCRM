...
<template>
  ...
  <button class="flex mx-auto text-white bg-teal-500 border-0 py-2 px-8 focus:outline-none hover:bg-teal-600 rounded text-lg" type="button" @click="searchCustomers" data-micromodal-trigger="modal-1">検索する</button>
</template>